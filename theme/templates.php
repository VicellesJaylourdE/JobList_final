...
<head>
<meta charset="utf-8">
<title>JobList / <?php echo $title;?></title>
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. (+63) 905-7496-617</p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">JobList<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          Kihare Road, Near Norther Bukidnon State College<br>
           Zip Code-8703 Manolo Fort Buk. PH.</address>
          <p>
            <i class="icon-phone"></i> (+63) 905-7496-617 <br>
            <i class="icon-envelope-alt"></i> JobList@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; JobList 2024 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
